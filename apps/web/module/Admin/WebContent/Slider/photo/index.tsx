...
import useAddSliderPhoto from "@/module/Admin/hooks/useAddSliderPhoto";
...
const SliderPhoto = () => {
  ...
  const { data, isLoading } = useGetSliderById(sliderId);
  const { mutateAsync: addMutateAsync } = useAddSliderPhoto(sliderId);
