...
import { LucideCalendar, LucideUser, LucideUserCircle } from "lucide-react";
    ...
    <>
      <div className="space-y-8">
        <div className="flex flex-col justify-start">
          ...
          <Typography variant="h3" className="text-gray-600 mt-2">
            <div className="flex items-center">
               <LucideUserCircle  size={18} className="mr-1"/>
            {author}
            </div>
